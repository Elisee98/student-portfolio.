...
# Projects section
    ...
    project_data = {
        ...
        "Year 2 Project": {
            "🤖 AI Chatbot": {
                ...
                "link": "https://github.com/Elisee98 /YEAR-II-C"
            }
        },
        "Year 3 Project": {
            "🌐  Ines Website": {
                ...
                "link": "https://github.com/Elisee98  /ines-website"
            }
        },
        "Dissertation": {
            "Developing e-health Platform to enhance healthcare literacy, providing rural communities with essential knowledge on prevention, treatment and wellness": {
                ...
                "link": "https://github.com/Elisee98  /healthcare-literacy-platform"
            }
        }
    }
    ...
    testimonials = [
        "Elisee is a brilliant problem solver! Her final year project was truly innovative. – Mr. Clement",
        "Elisee's dedication to AI is inspiring. She never stops learning! – Lecturer. SHIMIRWA Aline Valerie",
...
# Contact section
    ...
    st.markdown("📧 Email:** ")
    st.markdown("[📂 GitHub](https://github.com/Elisee98 )")
